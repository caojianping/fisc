<template>
    <div>
        ...
        <MobileTable :type="'notice'" :url="url" :params="params" :columns="columns" :callback="callback" :isFlag="true"
                     :isRefresh="isRefresh" @changeRefresh="(refresh)=>{this.isRefresh=refresh}"
...
<script>
    ...
    const analyzerCtrl = new AnalyzerController('aviation', true);
    analyzerCtrl.init();
